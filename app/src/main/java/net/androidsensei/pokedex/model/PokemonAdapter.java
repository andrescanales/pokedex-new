...
public class PokemonAdapter extends ArrayAdapter<Pokemon> {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            ...
            viewHolder.textView = (TextView) view.findViewById(R.id.list_item_name);
            viewHolder.imageView = (ImageView) view.findViewById(R.id.list_item_avatar);
            viewHolder.textViewDescription = (TextView) view.findViewById(R.id.list_item_description_textview);
            viewHolder.textViewHeight = (TextView) view.findViewById(R.id.list_item_height);
            viewHolder.textViewWeight = (TextView) view.findViewById(R.id.list_item_weight);
        ...
        holder.textViewDescription.setText(p.getHeight().toString() + "/" + p.getWeight().toString());
        holder.textViewHeight.setText(p.getHeight().toString());
        holder.textViewWeight.setText(p.getWeight().toString());
